...
```
    ...
    ## [1] "C:/Users/rba10kg/OneDrive - The Royal Botanic Gardens, Kew/Projects/BCB_notebook_2025/markdowns/practical_1"
...
```
    ...
    ## 1         2     Carnivore     Vertivore       Insessorial             -8.15             158.49    37461.21 -0.5939811 -0.0279868
    ## 2         3     Carnivore     Vertivore       Insessorial              8.23              44.98 22374973.00 -0.5381898 -0.2265797
    ## 3         2     Carnivore     Vertivore        Generalist            -10.10             -59.96 14309701.27 -0.4418864 -0.3419256
    ## 4         2     Carnivore     Vertivore       Insessorial             -5.45             150.68    35580.71 -0.4985385  0.2672395
    ## 5         3     Carnivore     Vertivore        Generalist             45.24              45.33  2936751.80 -0.4866800 -0.2710666
...
bio <- worldclim_global(var = 'bio',res = 10,path = 'environment')
...
```
    ...
    ## extent      : -180, 180, -90, 90  (xmin, xmax, ymin, ymax)
    ## coord. ref. : lon/lat WGS 84 (EPSG:4326) 
    ## source      : wc2.1_10m_bio_12.tif 
    ## name        : wc2.1_10m_bio_12 
    ## min value   :                0 
    ## max value   :            11191
...
``` r
# Zoom into the tree.
ape::zoom(fishtree, grep("Gymnothorax", fishtree$tip.label), subtree = FALSE, cex = 0.8)
```
...
ape::zoom(fishtree, grep("Gymnothorax", fishtree$tip.label), subtree = TRUE, cex = 0.8)
```
...
# Use the plot phylo function from phytools to plot a fan tree.
plot.phylo(ran_turdidae_tree, type = 'fan', cex = 0.5, font = 4)
```
...
plot.phylo(pruned_birdtree, font = 3)
```
...
```
    ...
    ##   [1]  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE FALSE FALSE
